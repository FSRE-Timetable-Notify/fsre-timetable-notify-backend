...
public class FsreTimetableNotifyBackendControllerAdvice {
	...
	public ResponseEntity<FsreError> handleException(Exception e) {
		...
		final FsreError fsreException = new FsreError(HttpStatus.INTERNAL_SERVER_ERROR, "Internal Server Error",
				e.getMessage());
	...
	public ResponseEntity<FsreError> handleMissingServletRequestParameterException(
		...
		final FsreError fsreException = new FsreError(HttpStatus.BAD_REQUEST, "Bad Request", e.getMessage());
