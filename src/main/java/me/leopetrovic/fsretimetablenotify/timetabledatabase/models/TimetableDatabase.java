...
public class TimetableDatabase {
	@Schema(description = "List of study programs (id of the study program and readable name)", requiredMode = RequiredMode.REQUIRED)
	private List<IdNamePair<Long>> studyPrograms;

	@Schema(description = "List of classrooms (id of the classroom and readable name)", requiredMode = RequiredMode.REQUIRED)
	private List<IdNamePair<Long>> classRooms;

	@Schema(description = "List of event types (id of the event type and readable name)", requiredMode = RequiredMode.REQUIRED)
	private List<IdNamePair<String>> eventTypes;

	@Schema(description = "List of subjects (id of the subject and readable name)", requiredMode = RequiredMode.REQUIRED)
	private List<IdNamePair<Long>> subjects;

	@Schema(description = "List of teachers (id of the teacher and readable name)", requiredMode = RequiredMode.REQUIRED)
	...
	public static class IdNamePair<T> {
		@Schema(description = "The ID of the item", requiredMode = RequiredMode.REQUIRED)
		private T id;
		@Schema(description = "The name of the item", requiredMode = RequiredMode.REQUIRED)
		private String name;
	}
