...
public class TimetableDatabaseDeserializer extends JsonDeserializer<TimetableDatabase> {
	...
	@Override
	public TimetableDatabase deserialize(JsonParser p, DeserializationContext ctxt) throws IOException, JacksonException {
	...
	private List<IdNamePair<Long>> parseIdNamePairs(JsonNode table, boolean parseIdAsLong, boolean useShortName) {
	...
	private List<IdNamePair<String>> parseIdNamePairs(JsonNode table, boolean useShortName) {
