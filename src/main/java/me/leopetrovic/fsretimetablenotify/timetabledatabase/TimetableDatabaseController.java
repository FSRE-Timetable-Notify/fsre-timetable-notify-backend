...
public class TimetableDatabaseController {
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Timetable database retrieved successfully", content = {
					@Content(mediaType = "application/json", schema = @Schema(implementation = TimetableDatabase.class))
			})
	})
