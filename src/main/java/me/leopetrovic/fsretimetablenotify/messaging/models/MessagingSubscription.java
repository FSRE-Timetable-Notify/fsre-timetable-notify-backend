...
public class MessagingSubscription {
	...
	@Schema(description = "The ID of the subscription", requiredMode = RequiredMode.REQUIRED)
	private UUID id;
	...
	@Schema(description = "The ID of the study program to subscribe to", requiredMode = RequiredMode.REQUIRED)
